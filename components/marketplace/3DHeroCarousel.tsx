...
const heroProducts: HeroProduct[] = [
  {
    ...
    description: "Exquisite handcrafted crown featuring authentic Zambian malachite stones, worn by royalty for centuries",
    price: 2499.99,
    originalPrice: 3299.99,
    heroImage: "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=1200&q=80",
    category: "Royal Jewelry",
    vendor: { name: "Royal Heritage Artisans", verified: true },
    rating: 5.0,
    luxuryRating: 5,
    tags: ["Royal", "Handcrafted", "Malachite", "Limited Edition"],
    isFeatured: true,
    isNew: true
  },
  {
    id: "hero2", 
    name: "Ceremonial Chitenge Royal Ensemble",
    description: "Traditional royal ceremonial attire crafted from premium silk with gold threading, representing Zambian heritage",
    price: 1299.99,
    originalPrice: 1899.99,
    heroImage: "https://images.unsplash.com/photo-1594736797933-d0300ad942ed?w=1200&q=80",
    category: "Traditional Fashion",
    vendor: { name: "Heritage Fashion House", verified: true },
    rating: 4.9,
    luxuryRating: 5,
    tags: ["Traditional", "Silk", "Gold Thread", "Ceremonial"],
    isFeatured: true,
    flashSale: true
  },
  {
    id: "hero3",
    name: "Master Craftsman Wood Sculpture",
    description: "Magnificent elephant sculpture carved from sustainable Zambian hardwood by master artisans",
    price: 899.99,
    originalPrice: 1199.99, 
    heroImage: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1200&q=80",
    category: "Art & Sculptures",
    vendor: { name: "Master Craftsmen Collective", verified: true },
    rating: 4.8,
    luxuryRating: 4,
    tags: ["Handcrafted", "Sustainable", "Wildlife", "Art"],
    isFeatured: true
  }
];
