      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50">
        ...
        <main className="flex items-center justify-center py-20">
          <motion.div
            ...
            className="max-w-md mx-auto bg-white rounded-3xl shadow-2xl p-8 border border-blue-100"
          >
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-3/4 right-1/4 w-96 h-96 bg-gradient-to-r from-orange-400/10 to-pink-400/10 rounded-full blur-3xl"
        />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.02, y: -8 }} transition={{ type: "spring", stiffness: 300 }}>
              <Card className="bg-white/90 backdrop-blur-xl border-white/50 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden group">
            ...
            {/* Cart Total */}
            <motion.div whileHover={{ scale: 1.02, y: -8 }} transition={{ type: "spring", stiffness: 300 }}>
              <Card className="bg-white/90 backdrop-blur-xl border-white/50 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden group cursor-pointer" onClick={() => router.push('/cart')}>
                <CardContent className="p-6 relative">
            ...
            {/* Wishlist */}
            <motion.div whileHover={{ scale: 1.02, y: -8 }} transition={{ type: "spring", stiffness: 300 }}>
              <Card className="bg-white/90 backdrop-blur-xl border-white/50 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden group cursor-pointer" onClick={() => router.push('/wishlist')}>
                <CardContent className="p-6 relative">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 space-y-12">
            ...
            {quickActions.map((action, index) => (
              ...
              >
                <Link href={action.href}>
                  <Card className="bg-white/90 backdrop-blur-xl border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer group overflow-hidden h-full">
        ...
        >
          {/* Recent Orders */}
          <Card className="bg-white/90 backdrop-blur-xl border-white/50 shadow-xl">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {trendingProducts.map((product, index) => (
              ...
              >
                <Card className="bg-white/90 backdrop-blur-xl border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer group overflow-hidden">
                  <CardContent className="p-6 text-center">
