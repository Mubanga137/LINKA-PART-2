      ...
      <main className="py-8 relative z-10">
        ...
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <motion.div 
              className="bg-gradient-to-r from-violet-50 via-purple-50 to-pink-50 rounded-3xl p-12 mb-16 border border-purple-200/50 shadow-xl backdrop-blur-sm relative overflow-hidden"
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.3 }}
            >
              <motion.div 
                className="absolute inset-0 bg-gradient-to-r from-violet-500/5 via-purple-500/5 to-pink-500/5"
              ...
              <div className="relative z-10">
                <motion.h2 
                  className="text-4xl font-bold text-slate-900 mb-12 text-center bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent"
                  variants={headerVariants}
                >
                  ...
                  {[
                    {
                      icon: Users,
                      title: "Browse & Choose",
                      description: "Explore service categories and find the right professional for your needs",
                      color: "from-blue-500 to-indigo-600"
                    },
                    {
                      icon: Clock,
                      title: "Book & Schedule",
                      description: "Schedule appointments at your convenience with verified providers",
                      color: "from-purple-500 to-violet-600"
                    },
                    {
                      icon: Award,
                      title: "Get Quality Service",
                      description: "Receive professional service from rated and reviewed providers",
                    ...
                    >
                      ...
                      >
                        <div className={`w-20 h-20 bg-gradient-to-r ${step.color} rounded-3xl flex items-center justify-center mx-auto shadow-lg group-hover:shadow-2xl transition-all duration-300`}>
                          <step.icon className="h-10 w-10 text-white" />
                        </div>
                        <motion.div 
                          className={`absolute -inset-4 bg-gradient-to-r ${step.color} rounded-3xl opacity-20 blur-lg group-hover:opacity-40 transition-opacity duration-300`}
                          animate={{ scale: [1, 1.05, 1] }}
                          transition={{ duration: 2, repeat: Infinity, delay: index * 0.5 }}
                        />
                      </motion.div>
                      <h3 className="font-bold text-slate-900 mb-4 text-xl group-hover:text-purple-600 transition-colors">
                        {step.title}
                      </h3>
